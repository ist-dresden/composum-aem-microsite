package com.composum.aem.commons.logging;
...
import com.composum.aem.commons.util.LoggerFormat;
...
public class Message implements Cloneable {
     ...
     * @param text    the untranslated text of message, possibly with placeholders {@literal {}} for arguments
     * @param args    optional arguments placed in placeholders. Caution: must be primitive types if this is to be
     *                transmitted with JSON!
     */
